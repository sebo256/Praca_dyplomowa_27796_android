package com.praca.dyplomowa.android
...
import com.praca.dyplomowa.android.views.AddJobActivity
import com.praca.dyplomowa.android.views.JobApplyToActivityView
import com.praca.dyplomowa.android.views.adapters.JobAdapter
import com.praca.dyplomowa.android.views.viewModelCalendarJobList
...
class CalendarJobListView : AppCompatActivity() {
    ...
    private fun setupBackground() {
        when(resources.configuration.uiMode and Configuration.UI_MODE_NIGHT_MASK == Configuration.UI_MODE_NIGHT_YES){
            true -> binding.layoutCalendarJobListActivity.setBackgroundColor(ContextCompat.getColor(binding.root.context, R.color.background_dark))
            false -> binding.layoutCalendarJobListActivity.setBackgroundColor(ContextCompat.getColor(binding.root.context, R.color.white))
